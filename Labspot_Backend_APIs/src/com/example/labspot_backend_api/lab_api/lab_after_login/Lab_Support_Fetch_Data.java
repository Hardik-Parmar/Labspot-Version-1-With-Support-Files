...
public class Lab_Support_Fetch_Data 
{
	private String lab_name, lab_address, lab_city, lab_phone, lab_category, lab_established_year, lab_email, lab_password, lab_logo_name, lab_logo_url;

	public Lab_Support_Fetch_Data(String lab_name, String lab_address, String lab_city, String lab_phone,
			String lab_category, String lab_established_year, String lab_email, String lab_password,
			String lab_logo_name, String lab_logo_url) 
	{
		...
		this.setLab_password(lab_password);
