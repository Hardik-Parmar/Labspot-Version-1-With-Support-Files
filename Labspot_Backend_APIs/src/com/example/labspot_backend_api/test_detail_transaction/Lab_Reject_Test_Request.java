...
import Java_DAO.test_detail_transaction_DAO.Lab_Reject_Test_Request_DAO;
import send_mail.Lab_Reject_Test_Request_Generate_Mail;

@Path("test_detail_transaction")
public class Lab_Reject_Test_Request
{
	Lab_Take_Action_On_Test_Request_Bean lab_Take_Action_On_Test_Request_Bean;
	Lab_Reject_Test_Request_DAO lab_Reject_Test_Request_DAO;
	...
	public String placeTestRequestToLab(String json)
	{
		...
		lab_Reject_Test_Request_DAO = new Lab_Reject_Test_Request_DAO();
		
		result = lab_Reject_Test_Request_DAO.reject_Test_Request(lab_Take_Action_On_Test_Request_Bean);
		
		System.out.println("\nReturn Message from reject_Test_Request Method : - "+result);

		if(result.equals("Test Request Rejected"))
		{
			response = Lab_Reject_Test_Request_Generate_Mail.labRejectTestGenerateEmail(lab_Take_Action_On_Test_Request_Bean);
			
			System.out.println("\n\nReturn Message from labRejectTestGenerateEmail Method : - "+response);
