...
public class Delivery_User_Request_Accept_DAO 
{
	public String delivery_User_Accept_Delivery_Request(Delivery_User_Request_Accept_Bean bean)
	{
		try
		{	
			...
			if(temp == 1)
			{
				return "Delivery Request from User is Accepted Successfully";
			}
			else
			{
				return "Delivery Request from User is not Accepted";
			}
		}
		catch(Exception e)
		{
		...
		return "Something went wrong in Delivery User Request Accept";
	}
}