...
public class Delivery_Boy_At_Lab_Address_Verify_OTP_Verify_Bean 
{
	private String request_id, customer_name, customer_email, lab_name, lab_email, test_name, otp_from_delivery, date;

	public Delivery_Boy_At_Lab_Address_Verify_OTP_Verify_Bean(String request_id, String customer_name, String customer_email, String lab_name, String lab_email, String test_name, String otp_from_delivery, String date)
	{
