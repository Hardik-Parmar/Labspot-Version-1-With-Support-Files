...
public class User_Request_Delivery_Verify_otp_Verify_Bean 
{
	private String request_id, customer_name, customer_email, lab_name, test_name, otp_from_delivery, date;

	public User_Request_Delivery_Verify_otp_Verify_Bean(String request_id, String customer_name, String customer_email, String lab_name, String test_name, String otp_from_delivery, String date)
	{
