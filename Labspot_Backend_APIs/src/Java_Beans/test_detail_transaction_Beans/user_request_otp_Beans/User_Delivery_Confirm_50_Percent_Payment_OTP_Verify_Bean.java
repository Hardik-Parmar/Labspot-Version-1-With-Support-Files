...
public class User_Delivery_Confirm_50_Percent_Payment_OTP_Verify_Bean 
{
	private String request_id, customer_name, customer_email, lab_name, test_name, otp_from_delivery;

	public User_Delivery_Confirm_50_Percent_Payment_OTP_Verify_Bean(String request_id, String customer_name, String customer_email, String lab_name, String test_name, String otp_from_delivery)
	{
