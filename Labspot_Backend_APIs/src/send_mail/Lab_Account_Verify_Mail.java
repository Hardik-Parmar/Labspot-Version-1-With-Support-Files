...
public class Lab_Account_Verify_Mail implements Confidential_Details_Mail
{
	public static String labAccountVerifyEmail(String receiver_mail, String otp, String name)
	{
