...
public class Lab_Change_Address_Alert_Mail implements Confidential_Details_Mail 
{
	public static String labAddressChangeAlertEmail(String email, String name)
	{
