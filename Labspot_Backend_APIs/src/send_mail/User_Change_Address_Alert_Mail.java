...
public class User_Change_Address_Alert_Mail implements Confidential_Details_Mail 
{
	public static String userAddressChangeAlertEmail(String email, String name)
	{
