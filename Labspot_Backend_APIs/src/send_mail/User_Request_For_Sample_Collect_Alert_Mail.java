...
public class User_Request_For_Sample_Collect_Alert_Mail implements Confidential_Details_Mail 
{
	public static String userRequestForSampleCollectEmail(User_Request_For_Sample_Collect_Bean bean, String delivery_name, String delivery_address, String delivery_phone, String delivery_email)
	{
		String user = Confidential_Details_Mail.USER;
		String password = Confidential_Details_Mail.PASSWORD;
		String to = bean.getUser_email();
		...
		try 
		{
	        ...
	        System.out.println("\nUser Delivery Boy Assigned Email Sent");
	        
	        return "User Delivery Boy Assigned Email Sent";
	    }
	...
	public static String userDeliveryBoyRequestEmail(User_Request_For_Sample_Collect_Bean bean, String delivery_name, String delivery_address, String delivery_phone, String delivery_email)
	{
		String user = Confidential_Details_Mail.USER;
		String password = Confidential_Details_Mail.PASSWORD;
		String to = delivery_email;
		String subject = "You got a Request for Sample Collection";
		
		String message_text = "Hello "+delivery_name+"\n\nYou got and Request for Sample Collection from Customer Location your Request ID: - "+ bean.getRequest_id()+"\n\nCustomer Name: - " + bean.getUser_name() + "\nLab Name: - " + bean.getLab_name() + "\n\nPlease log-on into App for to View Request in Detail.\n\n- Thanks and Regards\nTeam LABSPOT";
