...
public class Lab_View_Pending_Order_Contents
{
    private String applicant_id, user_name, user_phone, user_email_temp, test_name, date_of_request;

    public Lab_View_Pending_Order_Contents(String applicant_id, String user_name, String user_phone, String user_email_temp, String test_name, String date_of_request)
    {
