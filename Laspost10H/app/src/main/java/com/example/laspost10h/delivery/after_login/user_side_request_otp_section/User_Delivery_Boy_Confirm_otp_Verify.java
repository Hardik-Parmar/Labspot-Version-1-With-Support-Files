...
public class User_Delivery_Boy_Confirm_otp_Verify extends Fragment
{
    View view;
    ...
    String verify_delivery_boy_otp;
                             ...
                             Bundle savedInstanceState)
    {
        ...
        view = inflater.inflate(R.layout.fragment_user_delivery_boy_confirm_otp_verify, container, false);
        ...
        user_lab_delivery_boy_confirm_otp_verify_otp_submit.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                verify_delivery_boy_otp = user_lab_delivery_boy_confirm_otp_verify_otp_enter.getText().toString();

                SimpleDateFormat simpleDateFormat = new SimpleDateFormat("dd / MM / yyyy HH : mm : ss", Locale.getDefault());
                String currentDateAndTime = simpleDateFormat.format(new Date());

                if(verify_delivery_boy_otp.equals(""))
                {
                ...
                else
                {
                    ...
                    {
                        getDeliveryBoyOTPVerify(delivery_received_request_id, delivery_received_applicant_name, delivery_received_applicant_email, delivery_received_lab_name, delivery_received_test_name, verify_delivery_boy_otp, currentDateAndTime);
                    }
    ...
    private void getDeliveryBoyOTPVerify(String request_id, String applicant_name, String applicant_email, String lab_name, String test_name, String otp_from_delivery, String date)
    {
        ...
        JsonObjectRequest delivery_Verify_OTP_To_Verify_Himself_POST_Request = new JsonObjectRequest(Request.Method.POST, Java_API_URLs.USER_SIDE_OTP_VERIFICATION_TO_VERIFY_DELIVERY_BOY, new JSONObject(jsonParameters), new Response.Listener<JSONObject>()
        {
            @Override
            public void onResponse(JSONObject response)
            {
                ...
                if (transaction_return_message.equals("Something went wrong in User Verify otp To Verify Delivery Person"))
                {
                ...
                else if (transaction_return_message.equals("Confirm Delivery Boy OTP is not Verified, Wrong OTP"))
                {
                    progressDialog.dismiss();
                ...
                else if (transaction_return_message.equals("Confirm Delivery Boy OTP Verified and Delivery Boy Verified Email Sent"))
                {
                    progressDialog.dismiss();
                    ...
                    User_Confirm_50_Percent_Payment_otp_Generate user_confirm_50_percent_payment_otp_generate = new User_Confirm_50_Percent_Payment_otp_Generate();
                    user_confirm_50_percent_payment_otp_generate.setArguments(bundle1);

                    FragmentManager fragmentManager = getFragmentManager();
                    fragmentManager.beginTransaction().replace(R.id.delivery_fragment_container, user_confirm_50_percent_payment_otp_generate).addToBackStack(null).commit();
                }
            }
        },
