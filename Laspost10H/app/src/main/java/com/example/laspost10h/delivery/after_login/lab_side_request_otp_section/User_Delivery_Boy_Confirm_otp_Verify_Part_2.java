...
public class User_Delivery_Boy_Confirm_otp_Verify_Part_2 extends Fragment
{
    View view;
    ...
    String verify_delivery_boy_part_2_otp;
                             ...
                             Bundle savedInstanceState)
    {
        ...
        view = inflater.inflate(R.layout.fragment_user_delivery_boy_confirm_otp_verify_part_2, container, false);
        ...
        lab_user_delivery_boy_confirm_otp_verify_otp_submit.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                verify_delivery_boy_part_2_otp = lab_user_delivery_boy_confirm_otp_verify_otp_enter.getText().toString();

                SimpleDateFormat simpleDateFormat = new SimpleDateFormat("dd / MM / yyyy HH : mm : ss", Locale.getDefault());
                String currentDateAndTime = simpleDateFormat.format(new Date());

                if(verify_delivery_boy_part_2_otp.equals(""))
                {
                    Toast.makeText(getActivity(), "Please fill out the OTP Field.\n\nAsk Customer to Check their Mail for OTP.", Toast.LENGTH_SHORT).show();
                }
                ...
                else
                {
                    ...
                    {
                        getDeliveryBoyOTPVerifyPart2(delivery_received_request_id, delivery_received_applicant_name, delivery_received_applicant_email, delivery_received_lab_name, delivery_received_test_name, verify_delivery_boy_part_2_otp, currentDateAndTime);
                    }
    ...
    private void getDeliveryBoyOTPVerifyPart2(String request_id, String applicant_name, String applicant_email, String lab_name, String test_name, String otp_from_delivery, String date)
    {
        ...
        JsonObjectRequest delivery_Verify_OTP_To_Verify_Himself_Part_2_POST_Request = new JsonObjectRequest(Request.Method.POST, Java_API_URLs.USER_SIDE_OTP_VERIFICATION_TO_VERIFY_DELIVERY_BOY_PART_2, new JSONObject(jsonParameters), new Response.Listener<JSONObject>()
        {
            @Override
            public void onResponse(JSONObject response)
            {
                ...
                if (transaction_return_message.equals("Something went wrong in User Request Delivery Verify otp Verify Part 2"))
                {
                ...
                else if (transaction_return_message.equals("Confirm Delivery Boy Part 2 OTP is not Verified, Wrong OTP"))
                {
                    progressDialog.dismiss();
                ...
                else if (transaction_return_message.equals("Confirm Delivery Boy Part 2 OTP Verified and Delivery Boy Part 2 Verified Email Sent"))
                {
                    progressDialog.dismiss();
                    ...
                    User_Confirm_50_Percent_Payment_otp_Generate_Part_2 user_confirm_50_percent_payment_otp_generate_part_2 = new User_Confirm_50_Percent_Payment_otp_Generate_Part_2();
                    user_confirm_50_percent_payment_otp_generate_part_2.setArguments(bundle1);

                    FragmentManager fragmentManager = getFragmentManager();
                    fragmentManager.beginTransaction().replace(R.id.delivery_fragment_container, user_confirm_50_percent_payment_otp_generate_part_2).addToBackStack(null).commit();
                }
            }
        },
