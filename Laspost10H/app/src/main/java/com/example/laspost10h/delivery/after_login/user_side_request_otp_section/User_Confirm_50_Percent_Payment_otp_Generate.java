...
public class User_Confirm_50_Percent_Payment_otp_Generate extends Fragment
{
    View view;
    ...
    MaterialTextView user_lab_confirm_50_percent_payment_otp_generate_title_2;

    Button user_lab_confirm_50_percent_payment_otp_generate_otp;
                             ...
                             Bundle savedInstanceState)
    {
        ...
        view = inflater.inflate(R.layout.fragment_user_confirm_50_percent_payment_otp_generate, container, false);
        ...
        //MaterialTextView
        user_lab_confirm_50_percent_payment_otp_generate_title_2 = (MaterialTextView) view.findViewById(R.id.user_lab_confirm_50_percent_payment_otp_generate_title_2);

        // Button
        user_lab_confirm_50_percent_payment_otp_generate_otp = (Button) view.findViewById(R.id.user_lab_confirm_50_percent_payment_otp_generate_otp);

        user_lab_confirm_50_percent_payment_otp_generate_title_2.setText("Please Collect Appropriate Sample for Testing from Customer.\n\n And You Collect "+ delivery_received_test_50_price + ".00 ₹ Amount From Customer as First 50% Payment of Test Price in CASH MODE ONLY.");

        user_lab_confirm_50_percent_payment_otp_generate_otp.setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(View v)
            {
                ...
                {
                    getUserConfirm50PercentPaymentOTPGenerate(delivery_received_request_id, delivery_received_applicant_name, delivery_received_applicant_email, delivery_received_lab_name, delivery_received_test_name);
                }
    ...
    private void getUserConfirm50PercentPaymentOTPGenerate(String request_id, String applicant_name, String applicant_email, String lab_name, String test_name)
    {
        ...
        JsonObjectRequest user_Confirm_50_Payment_OTP_Generate_POST_Request = new JsonObjectRequest(Request.Method.POST, Java_API_URLs.USER_SIDE_OTP_GENERATION_TO_VERIFY_50_PERCENT_PAYMENT, new JSONObject(jsonParameters), new Response.Listener<JSONObject>()
        {
            @Override
            public void onResponse(JSONObject response)
            {
                ...
                if (transaction_return_message.equals("Something went wrong in User Delivery Confirm 50 Percent Payment OTP Generate"))
                {
                ...
                else if (transaction_return_message.equals("OTP for Confirm 50 Percent Payment has not been generated"))
                {
                ...
                else if (transaction_return_message.equals("OTP for Confirm 50 Percent Payment has been generated Successfully and Delivery Boy User 50 Payment Confirm Email Sent"))
                {
                    progressDialog.dismiss();
                    ...
                    User_Confirm_50_Percent_Payment_otp_Verify user_confirm_50_percent_payment_otp_verify = new User_Confirm_50_Percent_Payment_otp_Verify();
                    user_confirm_50_percent_payment_otp_verify.setArguments(bundle1);

                    FragmentManager fragmentManager = getFragmentManager();
                    fragmentManager.beginTransaction().replace(R.id.delivery_fragment_container, user_confirm_50_percent_payment_otp_verify).addToBackStack(null).commit();
                }
            }
        },
        ...
        user_Confirm_50_Payment_OTP_Generate_POST_Request.setRetryPolicy(new RetryPolicy()
        {
            @Override
        ...
        requestQueue.add(user_Confirm_50_Payment_OTP_Generate_POST_Request);
    }
}