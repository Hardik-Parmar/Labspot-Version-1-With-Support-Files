...
public class Lab_Delivery_Boy_Confirm_otp_Generate extends Fragment
{
    View view;
    ...
    MaterialTextView user_lab_delivery_boy_confirm_otp_generate_title, user_lab_delivery_boy_confirm_otp_generate_request_id;
    MaterialTextView user_lab_delivery_boy_confirm_otp_generate_lab_name, user_lab_delivery_boy_confirm_otp_generate_lab_phone;
    MaterialTextView user_lab_delivery_boy_confirm_otp_generate_lab_email, user_lab_delivery_boy_confirm_otp_generate_test_name;
    MaterialTextView user_lab_delivery_boy_confirm_otp_generate_test_price;

    JustifiedTextView user_lab_delivery_boy_confirm_otp_generate_lab_address;
                             ...
                             Bundle savedInstanceState)
    {
        ...
        view = inflater.inflate(R.layout.fragment_lab_delivery_boy_confirm_otp_generate, container, false);
        ...
        user_lab_delivery_boy_confirm_otp_generate_lab_name = (MaterialTextView) view.findViewById(R.id.user_lab_delivery_boy_confirm_otp_generate_lab_name);
        user_lab_delivery_boy_confirm_otp_generate_lab_phone = (MaterialTextView) view.findViewById(R.id.user_lab_delivery_boy_confirm_otp_generate_lab_phone);
        user_lab_delivery_boy_confirm_otp_generate_lab_email = (MaterialTextView) view.findViewById(R.id.user_lab_delivery_boy_confirm_otp_generate_lab_email);
        ...
        //JustifiedTextView
        user_lab_delivery_boy_confirm_otp_generate_lab_address = (JustifiedTextView) view.findViewById(R.id.user_lab_delivery_boy_confirm_otp_generate_lab_address);
        ...
        user_lab_delivery_boy_confirm_otp_generate_lab_name.setText("Lab Name: - " + delivery_received_lab_name);
        user_lab_delivery_boy_confirm_otp_generate_lab_address.setText("Lab Address: - " + delivery_received_lab_address);
        user_lab_delivery_boy_confirm_otp_generate_lab_phone.setText("Lab Phone: - " + delivery_received_lab_phone);
        user_lab_delivery_boy_confirm_otp_generate_lab_email.setText("Lab E-Mail I'D: - " + delivery_received_lab_email);
        user_lab_delivery_boy_confirm_otp_generate_test_name.setText("Test Name: - " + delivery_received_test_name);
        user_lab_delivery_boy_confirm_otp_generate_test_price.setText("Test Price: - " + delivery_received_test_price + ".00 ₹");
        ...
        user_lab_delivery_boy_confirm_otp_generate_reached_otp.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                {
                    getDeliveryBoyVerifyAtLabLocation(delivery_received_request_id, delivery_received_applicant_name, delivery_received_lab_name, delivery_received_lab_email, delivery_received_test_name);
                }
        ...
        user_lab_delivery_boy_confirm_otp_generate_lab_phone.setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(View v)
            {
        ...
        user_lab_delivery_boy_confirm_otp_generate_lab_email.setOnClickListener(new View.OnClickListener()
        {
            @Override
            public void onClick(View v)
            {
    ...
    private void getDeliveryBoyVerifyAtLabLocation(String request_id, String applicant_name, String lab_name, String lab_email, String test_name)
    {
        ...
        JsonObjectRequest delivery_Person_At_Lab_Generate_OTP_To_Verify_Himself_POST_Request = new JsonObjectRequest(Request.Method.POST, Java_API_URLs.DELIVERY_BOY_AT_LAB_OTP_GENERATION_TO_VERIFY_DELIVERY_BOY, new JSONObject(jsonParameters), new Response.Listener<JSONObject>()
        {
            @Override
            public void onResponse(JSONObject response)
            {
                ...
                if (transaction_return_message.equals("Something went wrong in Delivery Boy At Lab Address Verify OTP Generate"))
                {
                ...
                else if (transaction_return_message.equals("OTP to Verify Delivery Person at Lab has not been generated"))
                {
                ...
                else if (transaction_return_message.equals("OTP to Verify Delivery Person at Lab has been generated Successfully and Delivery Boy Confirm OTP at Lab Email Sent"))
                {
                    progressDialog.dismiss();
                    ...
                    Lab_Delivery_Boy_Confirm_otp_Verify lab_delivery_boy_confirm_otp_verify = new Lab_Delivery_Boy_Confirm_otp_Verify();
                    lab_delivery_boy_confirm_otp_verify.setArguments(bundle1);

                    FragmentManager fragmentManager = getFragmentManager();
                    fragmentManager.beginTransaction().replace(R.id.delivery_fragment_container, lab_delivery_boy_confirm_otp_verify).addToBackStack(null).commit();
                }
            }
        },
        ...
        delivery_Person_At_Lab_Generate_OTP_To_Verify_Himself_POST_Request.setRetryPolicy(new RetryPolicy()
        {
            @Override
        ...
        requestQueue.add(delivery_Person_At_Lab_Generate_OTP_To_Verify_Himself_POST_Request);
    }
