...
public class LabViewPendingOrderCustomAdapter extends BaseAdapter
{
    ...
    public List<Lab_View_Pending_Order_Contents> final_list;

    public Activity activity_context;

    ArrayList<Lab_View_Pending_Order_Contents> arrayList;

    public LabViewPendingOrderCustomAdapter(Activity activity_context, List<Lab_View_Pending_Order_Contents> list_demo)
    {
        this.final_list = list_demo;
        this.activity_context = activity_context;
        arrayList = new ArrayList<Lab_View_Pending_Order_Contents>();
    ...
    public View getView(final int position, View view, ViewGroup parent)
    {
        ...
        if(newTestRequestRowView == null)
        {
            ...
            newTestRequestRowView = layoutInflater.inflate(R.layout.lab_view_pending_order_row_display, parent, false);

            viewHolder = new ViewHolder();

            viewHolder.id = (MaterialTextView) newTestRequestRowView.findViewById(R.id.lab_view_pending_order_id);
            viewHolder.user_name = (MaterialTextView) newTestRequestRowView.findViewById(R.id.lab_view_pending_order_applicant_name);
            viewHolder.user_phone = (MaterialTextView) newTestRequestRowView.findViewById(R.id.lab_view_pending_order_applicant_phone);
            viewHolder.user_email = (MaterialTextView) newTestRequestRowView.findViewById(R.id.lab_view_pending_order_applicant_mail);
            viewHolder.test_name  = (MaterialTextView) newTestRequestRowView.findViewById(R.id.lab_view_pending_order_test_name);
            viewHolder.date_of_request = (MaterialTextView) newTestRequestRowView.findViewById(R.id.lab_view_pending_order_date_of_request);
